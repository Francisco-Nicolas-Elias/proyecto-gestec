...
Define la validación de entrada requerida en los endpoints que hoy carecen de ella o la tienen incompleta: intervenciones y mantenimiento de activos, restricción de rol al asignar responsables de un ticket, info institucional, y el catálogo editable de Admin (ubicaciones, tipos de componente, marcas, proveedores, áreas).
